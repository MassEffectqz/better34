...
const RU = {
  ...
  'menu.viewed': 'Просмотры',
  'menu.markViewed': 'Отметить загруженное',
  'menu.unmarkViewed': 'Снять отметку',
  ...
  'viewed.newEmpty': 'Непросмотренных нет',
  'viewed.seenEmpty': 'Просмотренных нет',
  'viewed.empty': 'Непросмотренных нет — открывайте посты из ленты, и они будут отмечены',
  'viewed.marked': 'Загруженное отмечено виденным',
  'viewed.markNone': 'В ленте пока нет постов',
  'viewed.unmarked': 'Отметка снята',
  'viewed.unmarkNone': 'Откройте пост или выделите его в сетке',
...
const EN = {
  ...
  'menu.viewed': 'View history',
  'menu.markViewed': 'Mark loaded as seen',
  'menu.unmarkViewed': 'Remove mark',
  ...
  'viewed.new': 'New',
  'viewed.seen': 'Seen',
  'viewed.newEmpty': 'No unviewed posts',
  'viewed.seenEmpty': 'No viewed posts',
  'viewed.empty': 'No unviewed posts — open posts from the feed and they will be marked',
  'viewed.marked': 'Loaded posts marked as seen',
  'viewed.markNone': 'The feed is empty',
  'viewed.unmarked': 'Mark removed',
  'viewed.unmarkNone': 'Open a post or select it in the grid',
